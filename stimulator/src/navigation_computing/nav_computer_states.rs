...
pub async fn stop_motors(chassis: &Arc<sync::Mutex<SimulatedChassis>>) {
...
impl Direction {
    ...
    async fn motors_setting(&self, is_slow: bool, chassis: &Arc<sync::Mutex<SimulatedChassis>>) {
        match self {
...
impl RunnableNavState for Stopped {
    async fn run(
        ...
        //TODO: nu se foloeste mai niciodata return typeu din functia in care sunt deci e oki daca
        //doar dai un print la eroare ig
