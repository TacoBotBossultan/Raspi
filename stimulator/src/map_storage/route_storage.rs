...
impl MapStorage {
    ...
    //TODO: folosesti valoarea din asta in mission controller sa-i si ii dai pop la rezultatul asta cu fiecare
    //pozitie si ii dai pass la navigation computer
    // dar de undeee stii ca si-a terminat cursa nav computeru catre pozitia curenta din queue si
    // stii sa treci la urmatoru, ca nu e blocking?? igig idk poate il fac sa fie blockign
